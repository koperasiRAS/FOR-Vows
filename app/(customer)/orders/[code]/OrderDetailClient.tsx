...
export function OrderDetailClient() {
 ...
 useEffect(() => {
 if (!orderCode || !authChecked) { queueMicrotask(() => setLoading(false)); return; }
 ...
 <p className="text-[10px] uppercase tracking-widest text-stone-400 font-label mb-1">Template</p>
 ...
 style={{ background: `linear-gradient(160deg, ${templateGradientFrom} 0%, ${templateGradientTo} 100%)` }}
 />
