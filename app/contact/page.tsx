      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 pt-12 pb-16 text-center">
        <ScrollReveal>
          <SectionHeading
            ...
            title="Let's Create Your Invitation"
            subtitle="Tell us about your wedding and we'll help you find the perfect invitation — or craft something entirely new."
          />
        </ScrollReveal>
      </div>
            ...
            <div className="space-y-8">
              ...
              <div className="p-8 border border-[#c9a96e]/20 bg-[#0f0f0f] space-y-4">
                ...
                <p className="text-sm text-[#6a6a6a] leading-relaxed">
                  For immediate assistance, questions, or to discuss your
                  vision — reach us directly on WhatsApp.
                </p>
                <a
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a
                        href="https://instagram.com/forvows"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm text-[#faf8f5] hover:text-[#c9a96e] transition-colors"
                      >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-xs text-[#6a6a6a]">Location</p>
              ...
              <div className="p-6 border border-white/[0.05] bg-[#0a0a0a]">
                <p className="text-xs text-[#6a6a6a]">
                  <span className="text-[#c9a96e]">Response time:</span>{" "}
                  Within 24 hours on business days. For urgent inquiries, please
                  use WhatsApp.
                </p>
              </div>
            </div>
